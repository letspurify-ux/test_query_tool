...
pub const SQL_KEYWORDS: &[&str] = &[
    ...
    "CONNECT", "START", "PRIOR", "LEVEL", "SIBLINGS", "NOCYCLE",
    "CONNECT_BY_ROOT", "CONNECT_BY_ISLEAF", "CONNECT_BY_ISCYCLE", "SYS_CONNECT_BY_PATH",
    // Oracle 12c+ joins
    "LATERAL", "APPLY",
    // Analytic function window clauses
    "ROWS", "RANGE", "UNBOUNDED", "PRECEDING", "FOLLOWING", "CURRENT",
    "NULLS", "FIRST", "LAST", "KEEP", "RESPECT", "IGNORE",
    "WITHIN",
    // Oracle 12c+ FETCH clause
    "NEXT", "ONLY", "PERCENT", "TIES",
    // PL/SQL keywords
    "EXCEPTION", "RAISE", "PRAGMA", "AUTONOMOUS_TRANSACTION", "EXCEPTION_INIT",
    "FORALL", "BULK", "COLLECT", "LOOP", "WHILE", "IF", "ELSIF", "EXIT", "CONTINUE", "GOTO",
    ...
    // Miscellaneous
    "NATURAL", "EDITIONABLE", "NONEDITIONABLE", "SHARING", "METADATA", "NONE",
    "COMPILE", "DEBUG", "REUSE", "SETTINGS", "SPECIFICATION", "INVALIDATE",
    "ENABLE", "DISABLE", "VALIDATE", "NOVALIDATE", "RELY", "NORELY",
    "DEFERRABLE", "INITIALLY", "DEFERRED", "IMMEDIATE",
    "STORAGE", "TABLESPACE", "LOGGING", "NOLOGGING", "PARALLEL", "NOPARALLEL",
    "COMPRESS", "NOCOMPRESS", "CACHE", "NOCACHE",
    "MATERIALIZED", "REFRESH", "COMPLETE", "FAST", "FORCE", "NEVER",
    "SYNONYM", "PUBLIC", "PRIVATE", "ROLE", "PROFILE", "USER", "SCHEMA",
    "DIRECTORY", "LIBRARY", "TYPE", "CLUSTER", "CONTEXT", "DIMENSION",
    "JAVA", "SOURCE", "RESOURCE", "CLASS",
    // INTERVAL and datetime parts
    "INTERVAL", "YEAR", "MONTH", "DAY", "HOUR", "MINUTE", "SECOND", "TO", "ZONE",
    "LOCAL", "TIME", "AT",
    // EXECUTE IMMEDIATE
    "EXECUTE", "EXEC",
    // MODEL clause keywords
    "MEASURES", "RULES", "AUTOMATIC", "SEQUENTIAL", "ITERATE", "UNTIL",
    "NAV", "SINGLE", "REFERENCE", "MAIN", "UPSERT",
    // XMLTABLE/JSON_TABLE keywords
    "COLUMNS", "PATH", "PASSING", "RETURNING", "CONTENT", "DOCUMENT",
    "WELLFORMED", "ERROR", "EMPTY", "FORMAT", "WRAPPER", "CONDITIONAL",
    "UNCONDITIONAL", "ABSENT", "NESTED",
    // FLASHBACK keywords
    "RESTORE", "POINT", "BEFORE", "AFTER", "TRANSACTION",
    // FOR UPDATE keywords
    "NOWAIT", "WAIT", "SKIP", "LOCKED", "OF",
    // Analytic keywords
    "NTILE", "LEAD", "LAG", "FIRST_VALUE", "LAST_VALUE", "NTH_VALUE",
    "LISTAGG", "CUME_DIST", "PERCENT_RANK", "PERCENTILE_CONT", "PERCENTILE_DISC",
    // Additional Oracle keywords
    "PURGE", "RECYCLEBIN", "FLASHBACK", "ARCHIVE", "NOARCHIVE",
    "LOGGING", "NOLOGGING", "INITRANS", "MAXTRANS", "PCTFREE", "PCTUSED",
    "ORGANIZATION", "HEAP", "IOT", "OVERFLOW", "INCLUDING", "MAPPING",
    "MONITORING", "NOMONITORING", "USAGE",
    "GLOBAL", "TEMPORARY", "PRESERVE", "EXTERNAL",
    "BITMAP", "NOSORT", "REVERSE", "INVISIBLE", "VISIBLE",
    // Constraint keywords
    "EXCEPTIONS", "NOEXCEPTIONS", "USING_NLS_COMP",
    // Partitioning
    "PARTITION", "SUBPARTITION", "HASH", "LIST", "RANGE", "INTERVAL",
    "MAXVALUE", "MINVALUE", "LESS", "THAN", "STORE", "OVERFLOW",
    // LOB keywords
    "LOB", "STORE", "SECUREFILE", "BASICFILE", "DEDUPLICATE", "COMPRESS",
    "RETENTION", "FREEPOOLS", "PCTVERSION", "CHUNK", "ENABLE_STORAGE_IN_ROW",
    // Security
...
pub const ORACLE_FUNCTIONS: &[&str] = &[
    ...
    "EXP", "FLOOR", "LN", "LOG", "MOD", "NANVL", "POWER", "REMAINDER",
    "ROUND", "SIGN", "SIN", "SINH", "SQRT", "TAN", "TANH", "TRUNC",
    "WIDTH_BUCKET", "BITAND",
    // Character functions
    "ASCII", "ASCIISTR", "CHR", "COMPOSE", "CONCAT", "DECOMPOSE",
    "INITCAP", "INSTR", "LENGTH", "LOWER", "LPAD", "LTRIM",
    "NLS_INITCAP", "NLS_LOWER", "NLS_UPPER", "NLSSORT",
    "REGEXP_COUNT", "REGEXP_INSTR", "REGEXP_REPLACE", "REGEXP_SUBSTR",
    "REPLACE", "REVERSE", "RPAD", "RTRIM", "SOUNDEX", "SUBSTR",
    ...
    "ROUND", "SESSIONTIMEZONE", "SYSDATE", "SYSTIMESTAMP",
    ...
    "BIN_TO_NUM", "CAST", "CHARTOROWID", "CONVERT", "HEXTORAW",
    "RAWTOHEX", "ROWIDTOCHAR", "TO_BINARY_DOUBLE", "TO_BINARY_FLOAT",
    "TO_BLOB", "TO_NCHAR", "TO_NCLOB", "VALIDATE_CONVERSION",
    // NULL-related functions
    "COALESCE", "DECODE", "DUMP", "EMPTY_BLOB", "EMPTY_CLOB",
    "GREATEST", "LEAST", "LNNVL", "NULLIF", "NVL", "NVL2",
    // Aggregate functions
    "AVG", "COLLECT", "CORR", "COUNT", "COVAR_POP", "COVAR_SAMP",
    "CUME_DIST", "DENSE_RANK", "FIRST", "GROUP_ID", "GROUPING",
    "GROUPING_ID", "LAST", "LISTAGG", "MAX", "MEDIAN", "MIN",
    "PERCENT_RANK", "PERCENTILE_CONT", "PERCENTILE_DISC",
    "RANK", "REGR_SLOPE", "REGR_INTERCEPT", "REGR_COUNT", "REGR_R2",
    "REGR_AVGX", "REGR_AVGY", "REGR_SXX", "REGR_SYY", "REGR_SXY",
    "STDDEV", "STDDEV_POP", "STDDEV_SAMP", "SUM",
    "VAR_POP", "VAR_SAMP", "VARIANCE",
    "APPROX_COUNT_DISTINCT", "APPROX_PERCENTILE", "ANY_VALUE",
    // Analytic functions
    ...
    "JSON_ARRAYAGG", "JSON_OBJECTAGG", "JSON_EXISTS", "JSON_SERIALIZE",
    "JSON_MERGEPATCH", "JSON_TRANSFORM", "JSON_SCALAR", "JSON_EQUAL",
    // XML functions
    "XMLAGG", "XMLELEMENT", "XMLATTRIBUTES", "XMLFOREST", "XMLROOT",
    "XMLPARSE", "XMLSERIALIZE", "XMLQUERY", "XMLTABLE", "XMLEXISTS",
    "XMLSEQUENCE", "XMLCONCAT", "XMLCOMMENT", "XMLPI", "XMLCDATA",
    "XMLTRANSFORM", "XMLCAST", "XMLCOLATTVAL", "XPATH", "EXISTSNODE",
    "EXTRACTVALUE", "UPDATEXML", "DELETEXML", "INSERTXMLBEFORE",
    "INSERTCHILDXML", "INSERTCHILDXMLBEFORE", "INSERTCHILDXMLAFTER",
    "APPENDCHILDXML",
    // Object reference functions
    "BFILENAME", "CARDINALITY", "DEREF", "MAKE_REF", "REF", "REFTOHEX",
    "VALUE", "TREAT",
    // Environment and session functions
    "SYS_CONTEXT", "SYS_GUID", "SYS_TYPEID", "UID", "USER", "USERENV",
    "ORA_HASH", "STANDARD_HASH", "VSIZE",
    // Hierarchical functions
    "SYS_CONNECT_BY_PATH",
    // Miscellaneous functions
    "BFILENAME", "COALESCE", "LNNVL", "NANVL", "NULLIF",
    ...
    "CLUSTER_ID", "CLUSTER_DETAILS", "CLUSTER_DISTANCE",
    "CLUSTER_PROBABILITY", "CLUSTER_SET",
    "FEATURE_COMPARE", "FEATURE_ID", "FEATURE_SET", "FEATURE_VALUE",
];
